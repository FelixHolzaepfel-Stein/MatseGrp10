...
ALTER TABLE `alliances`
  ADD CONSTRAINT `all_leader_id_fk` FOREIGN KEY (`Leader_ID`) REFERENCES `benutzer` (`ID`);
...
ALTER TABLE `alliance_user`
  ...
  ADD CONSTRAINT `all_user_id_fk` FOREIGN KEY (`User_ID`) REFERENCES `benutzer` (`ID`);
...
ALTER TABLE `payment_orders`
  ADD CONSTRAINT `pmt_method_ID_fk` FOREIGN KEY (`Method_ID`) REFERENCES `benutzer` (`ID`),
  ADD CONSTRAINT `pmt_user_ID_fk` FOREIGN KEY (`User_ID`) REFERENCES `benutzer` (`ID`);
